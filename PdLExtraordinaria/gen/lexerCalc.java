// Generated from F:/OneDrive/DAVID/1.UNIVERSIDAD/1.UAH/3º/1ºCUATRI/PDL/1. 24-25/LAB/Extraordinaria/PdLExtraordinaria/lexerCalc.g4 by ANTLR 4.13.2
...
public class lexerCalc extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BEGIN", "END", "IF", "THEN", "ELSE", "ENDIF", "WHILE", "ENDWHILE", "FUNC", 
			"ENDFUNC", "RETURN", "PRINT", "FOR", "TO", "DO", "PLUS", "MINUS", "TIMES", 
			"DIVIDE", "MOD", "SQRT", "POWER", "LPAREN", "RPAREN", "LESS", "GREATER", 
			"EQUALS", "IDENTIFIER", "NUMBER", "DIGITS", "COMMA", "SEMICOLON", "LINE_COMMENT", 
			"WS"
		};
	}
	...
	public lexerCalc(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "lexerCalc.g4"; }
